...
# This if condition will check if the user is loged in and if its true and then if the user tries to access the login page by search bar it will restrict and redirect it to the profiles page
